...
Releases ship as a ZIP you extract anywhere - the app is portable, with settings and emulators stored next to `XeniaManager.exe`. See [folder layout](../getting-started/installation.md#folder-layout-what-gets-created).
