...
- Game titles and artwork — Xbox marketplace database ([x360db](https://github.com/xenia-manager/x360db))
- Compatibility ratings — Canary / Mousehook / Netplay compatibility databases
- Recommended settings — [community optimized-settings database](https://github.com/xenia-manager/optimized-settings)
- Patch files — [Canary game patches](https://github.com/xenia-canary/game-patches) and [Netplay patches](https://github.com/AdrianCassar/Xenia-WebServices/tree/main/patches)
- Controller mappings — [gamecontrollerdb.txt](https://github.com/mdqinc/SDL_GameControllerDB) for Xenia SDL input
