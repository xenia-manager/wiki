...
3. Register in `source/XeniaManager.Core/Models/Theme.cs` (enum) and the `switch` in `ThemeService.cs`.
...
- Screenshots live in `docs/assets/images/`. Reference them directly so they appear automatically once added: `assets/images/<name>.png` from `docs/*.md`, `../assets/images/<name>.png` from `docs/guides/*.md`. Track missing ones in `SCREENSHOTS.md`.
