...
| ![Library - Carousel View](../assets/bigscreen/Carousel_Library.jpg){ data-gallery="overview" } |
|---|
| Library - Carousel View |

| ![Library - List View](../assets/bigscreen/List_Library.png){ data-gallery="overview" } |
|---|
| Library - List View |
...
| ![Game Details - Achievements Pane](../assets/bigscreen/Game_Details_Achievements.png){ data-gallery="overview" } |
|---|
...
| ![Gallery - Thumbnail Grid](../assets/bigscreen/Gallery.jpg){ data-gallery="overview" } |
|---|
...
| ![Profiles - Profile Picker](../assets/bigscreen/Profile_Selection.png){ data-gallery="overview" } |
|---|
