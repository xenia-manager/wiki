...
![Mousehook Controls Editor](../assets/images/mousehook-editor.png)

---

## Prerequisites

1. Install the **Xenia Mousehook** variant on the [Manage Xenia page](manage-xenia.md) (executable `xenia_canary_mousehook.exe`, config `xenia-canary-mousehook.config.toml`, plus `bindings.ini`).
